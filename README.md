...
| 「ヨットやって」 | **ヨット** | 5d6 を最大 3 回振り直し・役判定（ダイス絵文字・キープ色変え演出） |
| 「ヒット＆ブロウやって」 | **ヒット＆ブロウ** | Bot が 4 桁（または 3 桁）の数字を設定・最大 10 回で当てる数当てゲーム |
...
> | ヨット | `sv_dice_hakuji_d6_{1〜6}`・`sv_dice_suigyoku_d6_{1〜6}`（ダイスシリーズ 12 種） |
>
