...
| [2026-09-18_milestone_f06-calculate-enhancement.md](./2026-09-18_milestone_f06-calculate-enhancement.md) | F-06 数式計算 | 数式計算の強化（PM 絵文字／画像の清書・厳密値の併記・単位換算と微分） | 未着手 ⏳（前段のバグ修正 2 件は完了） |
...
| F-06 数式計算の強化        | PM 絵文字／画像の清書・厳密値の併記・単位換算と微分（前段のバグ修正 2 件は完了）    | 未着手 ⏳ | [2026-09-18_milestone_f06-calculate-enhancement.md](./2026-09-18_milestone_f06-calculate-enhancement.md) |
