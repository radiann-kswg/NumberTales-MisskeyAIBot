...
interface TimeSlot {
   ...
   *
   * **話題・状況だけを書き、口調やテンションは書かないこと。** ここに「元気な口調で」等を
   * 書くとキャラクターカードの口調設定を上書きしてしまい、穏やかな性格のキャラまで
   * 一律に明るく喋ってしまう（実機バグ 2026-08-30 / 52(イツギ) の朝投稿）。
   */
...
const TIME_SLOTS: readonly TimeSlot[] = [
  {
    ...
    label: '朝',
    promptAddendum:
      '朝の時間帯（6〜8時）です。夜のあいだコアフォルダ形態で休んでいたのがヒューマノイド形態に変形して起動したところ、という体で、軽い挨拶や作業開始の声かけをひとことつぶやいてください。',
  },
  {
    startHour: 12,
    endHour: 13,
    label: '昼',
    promptAddendum:
      '昼の時間帯（12〜13時）です。お昼らしい短いつぶやきをひとことしてください。',
  },
  {
    startHour: 17,
    endHour: 19,
  ...
  },
  {
    ...
    label: '深夜',
    promptAddendum:
      '深夜の時間帯（23〜翌5時）です。夜更けらしい話題で、作業中のフォロワーに寄り添う言葉をひとことつぶやいてください。',
  },
];
...
- 50文字以内
- 時間帯の指示は「話題・状況」の指定であって口調の指定ではない。口調・テンション・語尾は必ずキャラクター設定に従い、時間帯に合わせて明るさや元気さを足さないこと
